...
//multiple files with different name fields
exports.uploadTourImages = upload.fields([
  { name: 'imageCover', maxCount: 1 },
  { name: 'images', maxCount: 3 }
]);

//multiple files with same name fields
// upload.array('images',5);
//one upload file
// upload.single('images');

exports.resizeTourImages = catchAsync(async (req, res, next) => {
  // console.log(req.files); // use files while having multiple files
...
// /tours-within/233/center/-329.09090,-402.12321/unit/miles
...
// distances/-123.132132,-321.4432/unit/km
